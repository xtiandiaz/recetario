...
export enum LocalizedStringKey {
  ...
  Title_CategoryMiscFood = 'title-category-misc-food',
  ...
  Title_SectionPersonalCare = 'title-section-personal-care',
  // ---
  ...
  Title_IngredientEssentialOil = 'title-ingredient-essential-oil',
  ...
  Title_IngredientHoney = 'title-ingredient-honey',
  Title_IngredientWholeMilk = 'title-ingredient-whole-milk',
  Title_IngredientOatFlakes = 'title-ingredient-oat-flakes',
  Title_IngredientOliveOil = 'title-ingredient-olive-oil',
  Title_IngredientNutSeedMix = 'title-ingredient-nut-seed-mix',
